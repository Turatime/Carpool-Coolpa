...
-- Insert Vehicles
INSERT INTO vehicles (owner_id, model, plate_number, color) VALUES 
(1, 'Toyota Camry', 'กข 1234', 'White'),
(2, 'Honda Civic', 'ชญ 5678', 'Black');

-- Insert Trips
INSERT INTO trips (driver_id, origin, destination, departure_time, total_seats, available_seats, price_per_seat, status) VALUES 
(1, 'Bangkok', 'Chiang Mai', '2026-05-24 07:00:00', 4, 3, 350.0, 'active'),
(2, 'Bangkok', 'Chiang Mai', '2026-05-24 09:30:00', 4, 2, 320.0, 'active'),
(1, 'Phuket', 'Bangkok', '2026-06-01 10:00:00', 4, 4, 500.0, 'active');
...
(1, 3, 1, 5, 'Great driver, very punctual!'),
(2, 3, 2, 4, 'Smooth ride, but arrived a bit late.');
